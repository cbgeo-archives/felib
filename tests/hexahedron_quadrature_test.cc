...
TEST_CASE("Hexahedron quadratures are checked",
  ...
  SECTION("Hexahedron with a single quadrature") {
    ...
    auto quad =
        std::make_shared<felib::HexahedronQuadrature<Dim, Nquadratures>>();
  ...
  SECTION("Hexahedron with four quadratures") {
    ...
    REQUIRE(points(2, 2) == Approx(-std::sqrt(3.) / 3.).epsilon(Tolerance));
    
    REQUIRE(points(3, 0) == Approx(-std::sqrt(3.) / 3.).epsilon(Tolerance));
    REQUIRE(points(3, 1) == Approx(+std::sqrt(3.) / 3.).epsilon(Tolerance));
    REQUIRE(points(3, 2) == Approx(-std::sqrt(3.) / 3.).epsilon(Tolerance));

    REQUIRE(points(4, 0) == Approx(-std::sqrt(3.) / 3.).epsilon(Tolerance));
    REQUIRE(points(4, 1) == Approx(-std::sqrt(3.) / 3.).epsilon(Tolerance));
    REQUIRE(points(4, 2) == Approx(+std::sqrt(3.) / 3.).epsilon(Tolerance));
    
    REQUIRE(points(5, 0) == Approx(+std::sqrt(3.) / 3.).epsilon(Tolerance));
    REQUIRE(points(5, 1) == Approx(-std::sqrt(3.) / 3.).epsilon(Tolerance));
    REQUIRE(points(5, 2) == Approx(+std::sqrt(3.) / 3.).epsilon(Tolerance));
    
    REQUIRE(points(6, 0) == Approx(+std::sqrt(3.) / 3.).epsilon(Tolerance));
    REQUIRE(points(6, 1) == Approx(+std::sqrt(3.) / 3.).epsilon(Tolerance));
    REQUIRE(points(6, 2) == Approx(+std::sqrt(3.) / 3.).epsilon(Tolerance));
    
    REQUIRE(points(7, 0) == Approx(-std::sqrt(3.) / 3.).epsilon(Tolerance));
    REQUIRE(points(7, 1) == Approx(+std::sqrt(3.) / 3.).epsilon(Tolerance));
    REQUIRE(points(7, 2) == Approx(+std::sqrt(3.) / 3.).epsilon(Tolerance));
  ...
  SECTION("Hexahedron with nine quadratures") {
   ...
   auto quad =
    ...
    REQUIRE(points( 1, 1) == Approx(+0.).epsilon(Tolerance));
    ...
    REQUIRE(points( 5, 1) == Approx(-std::sqrt(3./5.)).epsilon(Tolerance));

    REQUIRE(points( 6, 0) == Approx(-std::sqrt(3./5.)).epsilon(Tolerance));
    REQUIRE(points( 6, 1) == Approx(+0.).epsilon(Tolerance));
    ...
    REQUIRE(points(10, 1) == Approx(+0.).epsilon(Tolerance));
    ...
    REQUIRE(points(12, 1) == Approx(-std::sqrt(3./5.)).epsilon(Tolerance));
    ...
    REQUIRE(points(14, 1) == Approx(+std::sqrt(3./5.)).epsilon(Tolerance));
    ...
    REQUIRE(points(16, 1) == Approx(+0.).epsilon(Tolerance));
    ...
    REQUIRE(points(19, 1) == Approx(0.).epsilon(Tolerance));
    ...
    REQUIRE(points(21, 1) == Approx(-std::sqrt(3./5.)).epsilon(Tolerance));
    ...
    REQUIRE(points(23, 1) == Approx(+std::sqrt(3./5.)).epsilon(Tolerance));
    ...
    REQUIRE(points(25, 1) == Approx(+0.).epsilon(Tolerance));
    ...
    // Check weights
    REQUIRE(weights.at( 0) == Approx( (5./9.)*(5./9.)*(5./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at( 1) == Approx( (5./9.)*(5./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at( 2) == Approx( (5./9.)*(5./9.)*(5./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at( 3) == Approx( (5./9.)*(5./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at( 4) == Approx( (5./9.)*(8./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at( 5) == Approx( (5./9.)*(5./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at( 6) == Approx( (5./9.)*(5./9.)*(5./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at( 7) == Approx( (5./9.)*(5./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at( 8) == Approx( (5./9.)*(5./9.)*(5./9.) ).epsilon(Tolerance));
    
    REQUIRE(weights.at( 9) == Approx( (5./9.)*(5./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(10) == Approx( (5./9.)*(8./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(11) == Approx( (5./9.)*(5./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(12) == Approx( (5./9.)*(8./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(13) == Approx( (8./9.)*(8./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(14) == Approx( (5./9.)*(8./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(15) == Approx( (5./9.)*(5./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(16) == Approx( (5./9.)*(8./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(17) == Approx( (5./9.)*(5./9.)*(8./9.) ).epsilon(Tolerance));
    
    REQUIRE(weights.at(18) == Approx( (5./9.)*(5./9.)*(5./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(19) == Approx( (5./9.)*(5./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(20) == Approx( (5./9.)*(5./9.)*(5./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(21) == Approx( (5./9.)*(5./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(22) == Approx( (5./9.)*(8./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(23) == Approx( (5./9.)*(5./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(24) == Approx( (5./9.)*(5./9.)*(5./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(25) == Approx( (5./9.)*(5./9.)*(8./9.) ).epsilon(Tolerance));
    REQUIRE(weights.at(26) == Approx( (5./9.)*(5./9.)*(5./9.) ).epsilon(Tolerance));
