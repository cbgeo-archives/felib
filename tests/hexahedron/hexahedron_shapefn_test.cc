...
TEST_CASE("Hexahedron shape functions are checked",
  ...
  SECTION("Hexahedron shape function with twenty nodes") {
    ...
    SECTION("Twenty noded hexahedron shape function for coordinates(0, 0, 0)") {
      ...
      REQUIRE(gradsf(19, 0) == Approx(-0.25).epsilon(Tolerance));
      ...
      REQUIRE(gradsf(13, 0) == Approx(+0.25).epsilon(Tolerance));
      ...
      REQUIRE(gradsf(18, 1) == Approx(0.25).epsilon(Tolerance));
      ...
      REQUIRE(gradsf(10, 2) == Approx(-0.25).epsilon(Tolerance));
    ...
    SECTION("Twenty noded hexahedron shape function for coordinates(-0.5, "
      ...
      REQUIRE(shapefn(10) == Approx(0.140625).epsilon(Tolerance));
      ...
      REQUIRE(shapefn(9) == Approx(0.140625).epsilon(Tolerance));
      REQUIRE(shapefn(11) == Approx(0.421875).epsilon(Tolerance));
      REQUIRE(shapefn(17) == Approx(0.046875).epsilon(Tolerance));
      REQUIRE(shapefn(19) == Approx(0.140625).epsilon(Tolerance));
      ...
      REQUIRE(shapefn(12) == Approx(0.421875).epsilon(Tolerance));
      ...
      // Edge nodes
      // G(0,1) = 0.125*(1. - xi(1))(1 - xi(2))(2*xi(0) + xi(1) + xi(2) + 1.)
      // G(1,1) = 0.125*(1. - xi(1))(1 - xi(2))(2*xi(0) - xi(1) - xi(2) - 1.)
      // G(2,1) = 0.125*(1. + xi(1))(1 - xi(2))(2*xi(0) + xi(1) - xi(2) - 1.)
      // G(3,1) = 0.125*(1. + xi(1))(1 - xi(2))(2*xi(0) - xi(1) + xi(2) + 1.)
      
      // G(4,1) = 0.125*(1. - xi(1))(1 + xi(2))(2*xi(0) + xi(1) - xi(2) + 1.)
      // G(5,1) = 0.125*(1. - xi(1))(1 + xi(2))(2*xi(0) - xi(1) + xi(2) - 1.)
      // G(6,1) = 0.125*(1. + xi(1))(1 + xi(2))(2*xi(0) + xi(1) + xi(2) - 1.)
      // G(7,1) = 0.125*(1. + xi(1))(1 + xi(2))(2*xi(0) - xi(1) - xi(2) + 1.)
      ...
      REQUIRE(gradsf(10, 0) == Approx(0.1875).epsilon(Tolerance));
      REQUIRE(gradsf(16, 0) == Approx(0.1875).epsilon(Tolerance));
      REQUIRE(gradsf(18, 0) == Approx(0.0625).epsilon(Tolerance));
      ...
      REQUIRE(gradsf(19, 0) == Approx(-0.09375).epsilon(Tolerance));
      ...
      REQUIRE(gradsf(13, 0) == Approx(+0.28125).epsilon(Tolerance));
      ...
      REQUIRE(gradsf(18, 1) == Approx(0.09375).epsilon(Tolerance));
      ...
      // G(17,1) = -0.5*(1 + xi(0))* xi(1) *(1 + xi(2))
      // G(19,1) = -0.5*(1 - xi(0))* xi(1) *(1 + xi(2))
      REQUIRE(gradsf(9, 1) == Approx(0.1875).epsilon(Tolerance));
      REQUIRE(gradsf(11, 1) == Approx(0.5625).epsilon(Tolerance));
      REQUIRE(gradsf(17, 1) == Approx(0.0625).epsilon(Tolerance));
      REQUIRE(gradsf(19, 1) == Approx(0.1875).epsilon(Tolerance));
    ...
    SECTION("Twenty noded hexahedron shape function for coordinates(0.5, "
      ...
      REQUIRE(shapefn(9) == Approx(0.140625).epsilon(Tolerance));
      REQUIRE(shapefn(11) == Approx(0.046875).epsilon(Tolerance));
      REQUIRE(shapefn(17) == Approx(0.421875).epsilon(Tolerance));
      REQUIRE(shapefn(19) == Approx(0.140625).epsilon(Tolerance));
      ...
      REQUIRE(shapefn(12) == Approx(0.046875).epsilon(Tolerance));
      REQUIRE(shapefn(13) == Approx(0.140625).epsilon(Tolerance));
      ...
      REQUIRE(gradsf(10, 0) == Approx(-0.1875).epsilon(Tolerance));
      REQUIRE(gradsf(16, 0) == Approx(-0.1875).epsilon(Tolerance));
      REQUIRE(gradsf(18, 0) == Approx(-0.5625).epsilon(Tolerance));
      ...
      REQUIRE(gradsf(19, 0) == Approx(-0.28125).epsilon(Tolerance));
      ...
      REQUIRE(gradsf(13, 0) == Approx(+0.09375).epsilon(Tolerance));
      ...
      REQUIRE(gradsf(2, 1) == Approx(0).epsilon(Tolerance));
      ...
      REQUIRE(gradsf(7, 1) == Approx(0.).epsilon(Tolerance));
      ...
      REQUIRE(gradsf(18, 1) == Approx(0.28125).epsilon(Tolerance));
      ...
      // G(19,1) = -0.5*(1 - xi(0))* xi(1) *(1 + xi(2))
      REQUIRE(gradsf(9, 1) == Approx(-0.1875).epsilon(Tolerance));
      REQUIRE(gradsf(11, 1) == Approx(-0.0625).epsilon(Tolerance));
      REQUIRE(gradsf(17, 1) == Approx(-0.5625).epsilon(Tolerance));
      REQUIRE(gradsf(19, 1) == Approx(-0.1875).epsilon(Tolerance));
