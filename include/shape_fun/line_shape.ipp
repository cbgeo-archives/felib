...
// 2-node Line element
template<>
void felib::LineShape<1, 2>::evaluate_shape_fun(const std::array<double, Tdim> &xi, std::array<double, numFun> &sFun) {
...
template<>
void felib::LineShape<1, 2>::evaluate_grad_shape_fun(const std::array<double, Tdim> &xi, std::array<std::array<double, numFun>, Tdim> &gradSfun) {
...
template<>
void felib::LineShape<1, 3>::evaluate_shape_fun(const std::array<double, Tdim> &xi, std::array<double, numFun> &sFun) {
...
template<>
void felib::LineShape<1, 3>::evaluate_grad_shape_fun(const std::array<double, Tdim> &xi, std::array<std::array<double, numFun>, Tdim> &gradSfun) {
