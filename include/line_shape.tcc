...
inline void felib::LineShape<1, 2>::evaluate_shape_fun(
    const std::array<double, 1>& xi, Eigen::Matrix<double, 1, 2>& sFun) {
...
inline void felib::LineShape<1, 2>::evaluate_grad_shape_fun(
    const std::array<double, 1>& xi, Eigen::Matrix<double, 1, 2>& gradSfun) {
...
inline void felib::LineShape<1, 3>::evaluate_shape_fun(
    const std::array<double, 1>& xi, Eigen::Matrix<double, 1, 3>& sFun) {
...
inline void felib::LineShape<1, 3>::evaluate_grad_shape_fun(
    const std::array<double, 1>& xi, Eigen::Matrix<double, 1, 3>& gradSfun) {
...
// template<> void felib::quadrature_points<2>(Eigen::Matrix<double, Tdim, 2>& qpoints) {
// 
//   qpoints(0) = -0.577350;
//   qpoints(1) = 0.577350;
// }
...
// template <unsigned Tdim, unsigned nfunctions>
// template <>
// void felib::quadrature_points<3>(Eigen::Matrix<double, Tdim, 3>& qpoints) {
// 
