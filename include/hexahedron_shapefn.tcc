...
inline Eigen::Matrix<double, 20, 3> felib::HexahedronShapeFn<
  ...
  grad_shapefn_(12, 0) = 0.25 * (1 - xi.at(1) * xi.at(1)) * (1 - xi.at(2));
  grad_shapefn_(8, 0) = -0.5 * xi.at(0) * (1 + xi.at(1)) * (1 - xi.at(2));
  grad_shapefn_(10, 0) = -0.25 * (1 - xi.at(1) * xi.at(1)) * (1 - xi.at(2));
  grad_shapefn_(17, 0) = -0.25 * (1 - xi.at(2) * xi.at(2)) * (1 - xi.at(1));
  grad_shapefn_(18, 0) = 0.25 * (1 - xi.at(2) * xi.at(2)) * (1 - xi.at(1));
  grad_shapefn_(11, 0) = 0.25 * (1 - xi.at(2) * xi.at(2)) * (1 + xi.at(1));
  grad_shapefn_(9, 0) = -0.25 * (1 - xi.at(2) * xi.at(2)) * (1 + xi.at(1));
  grad_shapefn_(19, 0) = -0.5 * xi.at(0) * (1 - xi.at(1)) * (1 + xi.at(2));
  grad_shapefn_(14, 0) = 0.25 * (1 - xi.at(1) * xi.at(1)) * (1 + xi.at(2));
  grad_shapefn_(13, 0) = -0.5 * xi.at(0) * (1 + xi.at(1)) * (1 + xi.at(2));
  grad_shapefn_(15, 0) = -0.25 * (1 - xi.at(1) * xi.at(1)) * (1 + xi.at(2));
  ...
  grad_shapefn_(12, 1) = -0.5 * xi.at(1) * (1 + xi.at(0)) * (1 - xi.at(2));
  grad_shapefn_(8, 1) = 0.25 * (1 - xi.at(0) * xi.at(0)) * (1 - xi.at(2));
  grad_shapefn_(10, 1) = -0.5 * xi.at(1) * (1 - xi.at(0)) * (1 - xi.at(2));
  grad_shapefn_(17, 1) = -0.25 * (1 - xi.at(2) * xi.at(2)) * (1 - xi.at(0));
  grad_shapefn_(18, 1) = -0.25 * (1 - xi.at(2) * xi.at(2)) * (1 + xi.at(0));
  grad_shapefn_(11, 1) = 0.25 * (1 - xi.at(2) * xi.at(2)) * (1 + xi.at(0));
  grad_shapefn_(9, 1) = 0.25 * (1 - xi.at(2) * xi.at(2)) * (1 - xi.at(0));
  grad_shapefn_(19, 1) = -0.25 * (1 - xi.at(0) * xi.at(0)) * (1 + xi.at(2));
  grad_shapefn_(14, 1) = -0.5 * xi.at(1) * (1 + xi.at(0)) * (1 + xi.at(2));
  grad_shapefn_(13, 1) = 0.25 * (1 - xi.at(0) * xi.at(0)) * (1 + xi.at(2));
  grad_shapefn_(15, 1) = -0.5 * xi.at(1) * (1 - xi.at(0)) * (1 + xi.at(2));
  ...
  grad_shapefn_(12, 2) = -0.25 * (1 - xi.at(1) * xi.at(1)) * (1 + xi.at(0));
  grad_shapefn_(8, 2) = -0.25 * (1 - xi.at(0) * xi.at(0)) * (1 + xi.at(1));
  grad_shapefn_(10, 2) = -0.25 * (1 - xi.at(1) * xi.at(1)) * (1 - xi.at(0));
  grad_shapefn_(17, 2) = -0.5 * xi.at(2) * (1 - xi.at(0)) * (1 - xi.at(1));
  grad_shapefn_(18, 2) = -0.5 * xi.at(2) * (1 + xi.at(0)) * (1 - xi.at(1));
  grad_shapefn_(11, 2) = -0.5 * xi.at(2) * (1 + xi.at(0)) * (1 + xi.at(1));
  grad_shapefn_(9, 2) = -0.5 * xi.at(2) * (1 - xi.at(0)) * (1 + xi.at(1));
  grad_shapefn_(19, 2) = 0.25 * (1 - xi.at(0) * xi.at(0)) * (1 - xi.at(1));
  grad_shapefn_(14, 2) = 0.25 * (1 - xi.at(1) * xi.at(1)) * (1 + xi.at(0));
  grad_shapefn_(13, 2) = 0.25 * (1 - xi.at(0) * xi.at(0)) * (1 + xi.at(1));
  grad_shapefn_(15, 2) = 0.25 * (1 - xi.at(1) * xi.at(1)) * (1 - xi.at(0));
  return grad_shapefn_;
}
